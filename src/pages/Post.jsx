  ...
  return (
    <div className=" flex w-full flex-col p-4 md:px-6 md:py-6">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex w-full flex-col gap-2">
                ...
                <textarea
                  ...
                  required
                  className="font-fontBody h-auto min-h-40 grow rounded-md border-2 bg-indigo-50 px-3 py-2 tracking-widest text-stone-800 ring-indigo-500  focus:outline-none focus:ring-2 "
                />
              </div>
            </div>
          </div>
      ...
      <div className="mb-7 flex w-full items-center justify-between border-b-[1px] border-t-[1px] border-stone-300">
        ...
        <p className="font-fontBody flex items-end px-2 py-3 md:px-4 md:py-4">
          <span className="pr-2">
            {
              <IconContext.Provider value={{ color: "#57534e" }}>
