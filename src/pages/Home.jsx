...
function Home() {
  return (
    <div className="grid h-full grid-rows-2 md:place-items-center lg:grid-cols-2">
      ...
      <div className="flex flex-col items-center gap-6 text-center lg:h-full lg:justify-end ">
      ...
      <div className="flex h-full w-full flex-col justify-end lg:justify-normal">
        <div className="fixed bottom-0 flex w-full items-center justify-center rounded-t-3xl bg-stone-200 py-8 md:static lg:bg-inherit">
          <Link
            to="/posts"
